...
(defun k9-set-colour-scheme()
  ...
  (custom-theme-set-faces
    ...
    `(mode-line ((t (:box nil :foreground ,plain :background "white"))))
    ...
    `(ivy-highlight-face ((t (:foreground ,coal :background ,bg))))
    ...
    `(magit-diff-context-highlight ((t (:background ,bg :foreground ,brightgravel))))
...
(cond
  ...
  (t (let* (
             ...
             (bg blackgravel)
             (hl-line darkgravel)
             (menu-selection-text yellow)
             (menu-selection-bg bg)
